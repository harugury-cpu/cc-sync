...
**⚠️ 내지 장수: Q3 발표 길이에 따라 결정된다.**
cover·closing·toc·section-divider는 카운트에서 제외한다.

| Q3 선택 | 내지 장수 | 섹션 구분 | 목차 |
|--------|---------|---------|-----|
| ① 5분 이하 | 2~3장 | 생략 | 생략 |
| ② 10분 | 3~4장 | 4장 이상일 때만 | 생략 |
| ③ 15~20분 | 5~6장 | 포함 | 섹션 2개 이상이면 추가 |
| ④ 30분 이상 | 7장+ | 포함 | 포함 |
| ⑤ 발표 없음 | 3~4장 | 4장 이상일 때만 | 생략 |

slides-grab의 내러티브 시퀀스를 결정된 내지 장수에 맞게 압축한다:
...
내지가 더 필요하면 슬라이드를 추가하고 closing은 마지막으로 밀린다. 섹션 구분이 필요한 장수면 section-divider를 삽입한다.
