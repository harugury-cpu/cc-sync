# 비주얼 baseline (Apple 톤)

당사는 Apple 디바이스용 케이스를 만든다. 케이스에 장착된 iPhone, iPad, MacBook이 자연스럽게 등장하는 것은 권장한다. 모든 비주얼 brief는 아래 baseline 2종 중 하나를 prefix로 사용한다.

## product_hero — 제품 자체 디테일·재질·구조·핏·호환성 증명이 핵심일 때
...
Sharp product edges, true material rendering: visible texture of case material, button cutouts, port openings, camera ring detail.
...
- product_hero: 호환성, 핏, 구조, 재질, 보호력의 시각적 증명, 메인 hero 컷
- lifestyle: 사용 상황, 휴대 컨텍스트, 라이프스타일 감성, 실사용 신뢰
- 혼합이 필요한 경우 product_hero를 기본으로 하고 비주얼 브리프의 Setting 필드에 환경 1줄을 추가한다.
- 셀링포인트마다 baseline 1개를 명시한다. baseline 없는 비주얼 브리프는 출력하지 않는다.
