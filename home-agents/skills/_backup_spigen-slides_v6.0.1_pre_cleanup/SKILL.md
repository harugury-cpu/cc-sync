...
| 파일 | 용도 |
|------|------|
| `spigen_build.py` | 슬라이드 빌더 (cover / slide / two_col / start_slide / 빌딩 블록) |
| `spigen_tokens.py` | 디자인 토큰 (HEADER / SHEET_GEOM / SPACING / TYPO / EMPHASIS) |
| `spigen_render_rules.md` | 디자인 금지 규칙 상세 사양 |
| `spigen_design_spec.md` | Type / spacing / color 정밀 사양 |
